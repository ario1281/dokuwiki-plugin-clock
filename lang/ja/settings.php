<?php
/**
 * @brief       Japanese language for clock plugin
...
$lang['clock_fmt_date']   = "時間フォーマットを指定します（デフォルトは<code>%h:%m:%s</code>）。 <ul><li>%h: 時 (hours) <li>%m: 分 (minutes) <li>%s: 秒 (seconds) <li>%f: ミリ秒 (milliseconds) </ul>";
$lang['clock_is_helpbar'] = "ヘルプバー（プラグイン情報とリンク）の有効／無効。";
$lang['clock_infopage']   = "指定された「wikiページ」へのリンクがヘルプバーに表示されます。";
